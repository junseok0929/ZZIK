...
def invalidate_photo_reviews(db, photo, reason):
    raise NotImplementedError("ZZIK_STARTER:approval-policy:invalidate_photo_reviews")

def invalidate_person_reviews(db, person_id, reason):
    raise NotImplementedError("ZZIK_STARTER:approval-policy:invalidate_person_reviews")
...
def approval_state(db,v):
    raise NotImplementedError("ZZIK_STARTER:approval-policy:approval_state")
...
def notify_after_commit(album_id,actor_id,kind,message,photo_id=None,version_id=None,target_ids=None):
    ...
    raise NotImplementedError("ZZIK_STARTER:approval-policy:notify_after_commit")
